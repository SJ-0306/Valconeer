...
Valconeer orchestras a zero-trust, role-based access control system in a mock hospital setting. It simulates multiple user roles, each with diffrent containers, Vault policies, and Falco monitoring rules.
